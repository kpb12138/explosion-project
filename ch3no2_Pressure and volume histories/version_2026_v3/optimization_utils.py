...
def run_optimization_algorithms(objective_func, bounds, initial_guess, param_names, step_name, config, results_dir, residuals_func=None):
    ...
    if use_least_squares:
        ...
        # Record initial guess for history tracking
        ...
        step_results = least_squares(
            ...
            bounds=(ls_lower, ls_upper), verbose=2, ftol=1e-8
        )
        
        # Record final result
        iter_history.append(step_results.x.copy())
        residual_history.append(objective_func(step_results.x))
